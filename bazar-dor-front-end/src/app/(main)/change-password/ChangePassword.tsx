...
export function ChangePassword() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFCFC] p-4 font-sans text-slate-800 pb-20">
      ...
      {isSuccess ? (
        <div className="bg-white rounded-[24px] shadow-[0_8px_30px_rgba(16,185,129,0.1)] border border-emerald-100 p-8 text-center animate-in zoom-in-95 duration-500 mt-10">
        ...
        <div className="bg-white rounded-[24px] shadow-[0_8px_30px_rgba(0,0,0,0.03)] border border-slate-50 p-6 animate-in slide-in-from-bottom-4 duration-500">
          ...
          <form onSubmit={handleUpdate}>
            <div className="mb-5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3.5 outline-none focus:border-emerald-500 focus:bg-white transition-all text-slate-800 font-medium placeholder:text-slate-400"
                  required
                />
                <button
                  type="button"
            ...
            <div className="mb-4">
              ...
              {newPassword.length > 0 && (
                <div className="mt-2.5 px-1 space-y-1 animate-in fade-in">
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-slate-50 border rounded-xl p-3.5 outline-none transition-all text-slate-800 font-medium placeholder:text-slate-400 ${
                    confirmPassword.length > 0 && newPassword !== confirmPassword
                    ? 'border-rose-300 focus:bg-white'
              ...
              {(confirmPassword.length > 0 && newPassword !== confirmPassword) && (
                <p className="text-[11px] font-semibold text-rose-500 mt-1.5 px-1 animate-in fade-in">
                  ⚠️ পাসওয়ার্ড দুটি মিলছে না
                </p>
              )}
            </div>
            ...
            >
              {isUpdating ? (
                <span className="animate-pulse">আপডেট হচ্ছে...</span>
              ) : (
                "আপডেট করুন"
              )}
            </button>
